...
class MerchantBaseLogic:
    ...
    def get_marketplace_url():
        marketplace_url = os.getenv('PRICEWARS_MARKETPLACE_URL', 'http://127.0.0.1:8080')
    ...
    def get_producer_url():
        producer_url = os.getenv('PRICEWARS_PRODUCER_URL', 'http://127.0.0.1:3050')
    ...
    def get_kafka_reverse_proxy_url():
        url = os.getenv('PRICEWARS_KAFKA_REVERSE_PROXY_URL', 'http://127.0.0.1:8001')
